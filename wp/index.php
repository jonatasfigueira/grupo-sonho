                    ...
                    <ul class="slides">
                        <?php foreach( $slides as $slide ): ?>
                            <li class=" ">
                                ...
                                <div class="btn-slide">
                                <a href="<?php echo $slide['caption']; ?>" ><?php echo $slide['alt']; ?></a>
                                </div>
    ...
    <section class="tag-contato">
        <div class="container">
            ...
            <div class="grid-6 form-content">
                <?php echo do_shortcode('[contact-form-7 id="1613" title="Contato Home" html_class="use-floating-validation-tip"]');?>   
            </div>
        </div>
    </section>
